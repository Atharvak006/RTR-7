...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Emoji 9: Atharva Rahul Kshirsagar");
...
{
    float coordinates_of_Point1_X = -0.46f;
    float coordinates_of_Point1_y = 0.35f;

    float coordinates_of_Point2_X = -0.26f;
    float coordinates_of_Point2_y = 0.55f;
...
void DrawRightEyeBrow(void)
{
    ...
    float coordinates_of_Point1_y = 0.55f;

    float coordinates_of_Point2_X = 0.46f;
    float coordinates_of_Point2_y = 0.35f;
